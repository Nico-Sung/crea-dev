            ...
            >
                ...
                >
                    ...
                    <div className="absolute bottom-4 right-4 bg-white/10 backdrop-blur-sm px-3 py-1">
                        <span className="font-rubik-mono text-xs text-white/80">
                ...
                <div
                    className="flip-card-back absolute inset-0 w-full h-full bg-black/95 rounded-sm overflow-hidden border border-white/20"
                    style={{
                ...
                >
                    <div className="absolute inset-0 p-6 flex flex-col">
                        <h4 className="font-rubik-mono text-lg md:text-xl text-white uppercase tracking-wider mb-1">
                            {album.title}
                        </h4>
                        <span className="font-rubik-mono text-xs text-white/50 mb-4">
                            {album.year}
                        </span>
                        ...
                        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
                            <ul className="space-y-2">
                                {album.tracklist.map((track, index) => (
                                    ...
                                    >
                                        <span className="font-rubik-mono text-xs text-white/40 w-5">
                                            {String(index + 1).padStart(2, "0")}
                                        </span>
                                        <span className="font-rubik-mono text-sm text-white/80 group-hover/track:text-white transition-colors">
                                            {track}
                                        </span>
                                    </li>
                                ))}
                        ...
                        <div className="mt-4 pt-4 border-t border-white/10">
                            <span className="font-rubik-mono text-xs text-white/40">
